...
blog_writer = Agent(
    model=LiteLlm(model=config.critic_model,
    ...
    - Use DuckDuckGo search tool to find relevant information and examples to support your writing.
    ...
    """,
    tools=[FunctionTool(duckduckgo_search_tool)],
